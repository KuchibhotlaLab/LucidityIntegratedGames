...
public class GameTwoConstants {
    ...
    public static final Vector2 F2W_CENTER = new Vector2(MODE_WORLD_SIZE/3,MODE_WORLD_SIZE/2);
    public static final Vector2 W2F_CENTER = new Vector2(MODE_WORLD_SIZE * 2/3,MODE_WORLD_SIZE/2);
